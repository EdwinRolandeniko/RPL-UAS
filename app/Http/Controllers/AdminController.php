...
use App\Models\KodeSuratKegiatan;
use App\Models\KodeSuratUndangan;
use App\Models\KodeSuratTugas;
use App\Models\KodeSuratBerita;
use App\Models\KodeSuratTugasdos;
...
class AdminController extends Controller
{
    ...
    public function simpan_srt_berita(Request $request)
    {
        ...
        if($count>0){
            // Session::flash('message', 'Already exist!');
            // Session::flash('message_type', 'danger');
            return redirect ('/adm-surat-berita-acara');
        }
    ...
    //SuratTugasdos
    public function tampil_srt_tugasdos()
    {
        // Membatasi hak akses user
        if(Auth::user()->role == 'Mahasiswa') {
            return redirect()->to('/home');
    ...
    public function detail_srt_tugasdos($id)
    {
    ...
    public function setuju_tugasdos($id)
    {
        Tugasdos::where('id', '=', $id)->update(['status' => 1]);
        return redirect()->back();
    }

    public function batal_tugasdos($id)
    {
        Tugasdos::where('id', '=', $id)->update(['status' => 2]);
        return redirect()->back();
    }

    public function buat_srt_tugasdos($id)
    {
        $det = Tugasdos::find($id);
    ...
    public function simpan_srt_tugasdos(Request $request)
    {
