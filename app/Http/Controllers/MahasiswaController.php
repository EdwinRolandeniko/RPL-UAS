...
class MahasiswaController extends Controller
{
    ...
    public function cetak_permohonan($id)
    {
        ...
        $datas = $permohonan->get();
        $pdf = PDF::loadView('mahasiswa.permohonan.surat', compact('permohonan','kd'));
        return $pdf->stream('surat_permohonan_'.$permohonan->id_user.'.pdf');
    }
    // Surat Permohonan
    ...
    public function cetak_kegiatan($id)
    {
        ...
        $datas = $kegiatan->get();
        $pdf = PDF::loadView('mahasiswa.kegiatan.surat', compact('kegiatan','kd'));
