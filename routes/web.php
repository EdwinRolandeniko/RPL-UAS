...
Route::get('/surat-permohonan/cetak/{id}', ['as' => 'mahasiswa.permohonan.surat', 'uses' => '\App\Http\Controllers\MahasiswaController@cetak_permohonan']);
...
Route::get('/adm-surat-berita-acara/detail/{id}', '\App\Http\Controllers\AdminController@detail_srt_berita');
Route::get('/adm-surat-berita-acara/setuju/{id}', '\App\Http\Controllers\AdminController@setuju_berita');
Route::get('/adm-surat-berita-acara/batal/{id}', '\App\Http\Controllers\AdminController@batal_berita');
Route::get('/adm-surat-berita-acara/buat/{id}', '\App\Http\Controllers\AdminController@buat_srt_berita');
Route::post('/adm-surat-berita-acara/simpan', '\App\Http\Controllers\AdminController@simpan_srt_berita');

// Routing Admin-Surat Tugasdos
Route::get('/adm-surat-tugas-dsn', '\App\Http\Controllers\AdminController@tampil_srt_tugasdos');
Route::get('/adm-surat-tugas-dsn/detail/{id}', '\App\Http\Controllers\AdminController@detail_srt_tugasdos');
Route::get('/adm-surat-tugas-dsn/setuju/{id}', '\App\Http\Controllers\AdminController@setuju_tugasdos');
Route::get('/adm-surat-tugas-dsn/batal/{id}', '\App\Http\Controllers\AdminController@batal_tugasdos');
Route::get('/adm-surat-tugas-dsn/buat/{id}', '\App\Http\Controllers\AdminController@buat_srt_tugasdos');
Route::post('/adm-surat-tugas-dsn/simpan', '\App\Http\Controllers\AdminController@simpan_srt_tugasdos');